    ...
    switch(item.type) {
      ...
      case 'image':
        return (
          ...
          >
            <Image 
            style={this.state.isMoving ? {backgroundColor: 'pink'} : {width: Dimensions.get('window').width, height: Math.min((item.height * Dimensions.get('window').width / item.width), item.height) || 100}}
