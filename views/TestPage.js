    ...
    props.list.forEach(item => {
      ...
      if(item.type=='TextInput'){
        ...
        let myAttr = {'data-attr': key}
          returnValue.push(<TextInput {...myAttr} style={styles.label} key={key} onFocus={(e) => this.handleChange(e))} onChange={this.handleChange.bind(this)} value={this.state.data.list[key].text}/>);
