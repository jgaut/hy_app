...
class TestPageScreen extends React.Component {
    ...
    props.list.forEach(item => {
      ...
      if(item.type=='TextInput'){
        //console.log(item.type);
          returnValue.push(<TextInput style={styles.label} key={key} onChangeText={texto=>{this.handleChange(texto, this)}}>{this.state.data.list[key].text}</TextInput>);
  ...
  handleChange = (e, f) =>{
    console.log("f : " + JSON.stringify(f.state));
    console.log("e : " + e);
    //this.setState({e: e});
  }
