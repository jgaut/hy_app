  ...
  renderItem = (item, itemSize, itemPaddingHorizontal) => {
    ...
    return(
      <TouchableOpacity
        ...
        style = {{ width: itemSize, height: itemSize, paddingHorizontal: itemPaddingHorizontal, paddingVertical: itemPaddingHorizontal, borderColor:"grey", backgroundColor: '#2196F3',}}
        onPress = { () => {
